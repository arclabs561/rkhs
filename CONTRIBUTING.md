# Contributing to rkhs

Thanks for your interest. rkhs is reproducing Kernel Hilbert Space: kernels, MMD, and kernel quantile embeddings (re-exports hopfield for AM).
...
- Commit messages: `rkhs: short lowercase description`. One commit per logical change.
